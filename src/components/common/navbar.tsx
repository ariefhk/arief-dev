...
const Navbar = () => {
  ...
  return (
    <FramerWrapper
      className={`h-fit w-fit fixed top-5 right-0 left-0 px-5   m-auto border-2 border-black rounded-full  p-2 bg-white-400 bg-clip-padding backdrop-filter backdrop-blur-sm bg-opacity-10 flex-row gap-3 transition ease-in-out delay-150  hover:-translate-y-1 hover:scale-100 max-sm:gap-1 ${

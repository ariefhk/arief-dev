...
const Aboutfooter = () => {
  const items = [
    { name: "Language", answer: "English/Bahasa", icon: <Languages className="h-11 w-11" /> },
    { name: "Nationality", answer: "Indonesia", icon: <Globe2 className="h-8 w-8" /> },
  ...
  return (
    <>
      {items.map((val, indx) => {
        return (
          <div className="p-1 w-fit relative" key={indx + 1}>
